...
import { InMemoryIdentityStorage } from './../../src/storage/memory/identity';
...
import { IStateStorage } from '../../src/storage/interfaces';
...
describe('credential wallet', () => {
  it('run in memory with 3 credential', async () => {
    const storage: IDataStorage = {
      credential: new InMemoryCredentialStorage(),
      identity: {} as InMemoryIdentityStorage,
      mt: {} as InMemoryMerkleTreeStorage,
      states: {} as IStateStorage
    };
