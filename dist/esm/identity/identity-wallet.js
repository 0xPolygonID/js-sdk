...
import { VerifiableConstants, BJJSignatureProof2021, MerklizedRootPosition, SubjectPosition, W3CCredential, Iden3SparseMerkleTreeProof, ProofType, IssuerData, CredentialStatusType } from '../verifiable';
import { pushHashesToRHS } from '../credentials';
...
export class IdentityWallet {
    ...
    async issueCredential(issuerDID, req, opts) {
        ...
        try {
            ...
            throw new Error(`Error create Iden3Credential ${e.message}`);
        }
