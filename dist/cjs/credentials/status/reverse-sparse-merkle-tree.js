...
class RHSResolver {
    ...
    async resolve(credentialStatus, credentialStatusResolveOptions) {
        ...
        try {
            return await this.getStatus(credentialStatus, credentialStatusResolveOptions.issuerDID, credentialStatusResolveOptions.issuerData);
        }
        catch (e) {
     ...
     * @returns Promise<RevocationStatus>
     */
    async getStatus(credentialStatus, issuerDID, issuerData) {
        ...
        try {
            ...
            const currentStateBigInt = (0, js_merkletree_1.newHashFromHex)(stateHex).bigInt();
            if (!(0, utils_1.isGenesisState)(issuerDID, currentStateBigInt)) {
        ...
        const hashedIssuerRoot = (0, js_merkletree_1.newHashFromBigInt)(latestState);
     ...
     * @param {IssuerData} issuerData
     */
    getRevocationStatusFromIssuerData(issuerDID, issuerData) {
