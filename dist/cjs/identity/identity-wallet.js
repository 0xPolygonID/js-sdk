...
class IdentityWallet {
    ...
    async createIdentity(opts) {
        ...
        if (opts.revocationOpts.type === verifiable_1.CredentialStatusType.Iden3ReverseSparseMerkleTreeProof) {
    ...
    async issueCredential(issuerDID, req, opts) {
        ...
        const coreClaim = await schema_processor_1.Parser.parseClaim(credential, coreClaimOpts);
