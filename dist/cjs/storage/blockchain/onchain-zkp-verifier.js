...
const zkp_verifier_abi_json_1 = __importDefault(require("./zkp-verifier-abi.json"));
...
class OnChainZKPVerifier {
    ...
    async submitZKPResponse(ethSigner, txData, zkProofResponses) {
        ...
        const provider = new ethers_1.ethers.providers.JsonRpcProvider(chainConfig);
        const verifierContract = new ethers_1.ethers.Contract(txData.contract_address, zkp_verifier_abi_json_1.default, provider);
