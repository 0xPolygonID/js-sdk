...
import { CredentialRequest, ICredentialWallet, TreesModel } from '../credentials';
...
export declare class IdentityWallet implements IIdentityWallet {
    ...
    generateIden3SparseMerkleTreeProof(issuerDID: DID, credentials: W3CCredential[], txId: string, blockNumber?: number, blockTimestamp?: number, treeState?: TreeState): Promise<W3CCredential[]>;
