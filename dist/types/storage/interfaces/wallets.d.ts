...
export interface IEthereumWallet {
     ...
     */
    signTypedData(keyId: KmsKeyId, typedData: TypedData, opts?: {
        [key: string]: unknown;
    }): Promise<Uint8Array>;
    /**
     ...
     * @param {Object} [opts] - Optional parameters
     */
    sendTransaction(keyId: KmsKeyId, request: TransactionRequest, opts?: {
        [key: string]: unknown;
     ...
     * @param {Object} [opts] - Optional parameters
     */
    estimateGas(keyId: KmsKeyId, request: TransactionRequest, opts?: {
        [key: string]: unknown;
    }): Promise<bigint>;
}
