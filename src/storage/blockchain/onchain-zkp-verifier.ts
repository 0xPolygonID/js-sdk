...
export class OnChainZKPVerifier implements IOnChainZKPVerifier {
  ...
  public async prepareTxArgsSubmitV1(
    ...
    if (txData.method_id.replace('0x', '') !== FunctionSignatures.SubmitZKPResponseV1.replace('0x', '')) {
      throw new Error(
        `prepareTxArgsSubmitV1 function doesn't implement requested method id. Only '${FunctionSignatures.SubmitZKPResponseV1}' is supported.`
      );
    }
  ...
  public async submitZKPResponse(
    ...
    if (txData.method_id.replace('0x', '') !== FunctionSignatures.SubmitZKPResponseV1.replace('0x', '') {
      throw new Error(
        `submitZKPResponse function doesn't implement requested method id. Only '${FunctionSignatures.SubmitZKPResponseV1}' is supported.`
      );
    }
  ...
  public async submitZKPResponseV2(
    ...
    if (txData.method_id.replace('0x', '') !== FunctionSignatures.SubmitZKPResponseV2.replace('0x', '')) {
      throw new Error(
        `submitZKPResponseV2 function doesn't implement requested method id. Only '${FunctionSignatures.SubmitZKPResponseV2}' is supported.`
      );
    }
  ...
  public async prepareTxArgsSubmitV2(
    ...
    if (txData.method_id.replace('0x', '') !== FunctionSignatures.SubmitZKPResponseV2.replace('0x', '')) {
      throw new Error(
        `submit cross chain doesn't implement requested method id. Only '${FunctionSignatures.SubmitZKPResponseV2}' is supported.`
      );
    }
    if (!this._opts?.didResolverUrl) {
      throw new Error(`did resolver url required for crosschain verification`);
