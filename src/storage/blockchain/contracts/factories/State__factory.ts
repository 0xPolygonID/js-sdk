...
export class State__factory {
  ...
  static createInterface(): StateInterface {
    return new Interface(_abi) as StateInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): State {
    return new Contract(address, _abi, runner) as unknown as State;
  }
}
