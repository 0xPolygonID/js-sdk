...
export const ErrNotEnvelopeStub =
    "the envelope doesn't contain field protected";
...
export const ErrSenderNotUsedTokenCreation =
    'sender of message is not used for jwz token creation';


// ZKP-Packer Errors
export const ErrPackedWithUnsupportedCircuit =
    'message was packed with unsupported circuit';
