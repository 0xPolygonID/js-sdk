import { IEIP712Provider, IKeyProvider } from '../kms';
 ...
 */
export class Sec256k1Provider implements IKeyProvider, IEIP712Provider {
  /**
  ...
  async signTypedData(
    ...
    const privateKeyHex = await this._keyStore.get({ alias: keyId.id });
